        ...
        <section>
            ...
            <div className="timeline relative w-11/12 mx-auto"> {/*max-w-screen-2xl*/}
                {timelineData.map((item, index) => (
                    ...
                    >
                        ...
                        >
                            <h2 className="text-sm sm:text-base md:text-lg font-bold text-neutral-50">{item.company}</h2>
                            <small className="text-xs lg:text-sm text-neutral-50 mb-1">{item.period}</small>
                            <p className="text-xs sm:text-sm md:text-base lg:text-lg text-neutral-50">{item.description}</p>
                            <span
            ...
            <div className="w-11/12 flex justify-center mt-8 relative max-sm:left-6 mx-auto"> {/*max-w-screen-2xl*/}
                <MagicButton
                    ...
                    href="https://raw.githubusercontent.com/YanBerdin/YanBerdin/master/Doc/Yan_Berdin.pdf"
                />
            </div>
        </section>
    );
