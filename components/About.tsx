...
export const About = () => {
  return (
    <>
      <div id="about" className="h-44 "></div>
      ...
      <section
        id="about"
        className="bg-slate-900/[0.8] border border-slate-800 backdrop-blur-xl rounded-lg justify-center w-11/12 mx-auto h-full p-4 sm:p-10 mt-10 sm:mt-20 lg:mt-10 mb-10">
        <div className=" flex flex-col lg:flex-row gap-4 md:gap-12 p-4"> {/* lg:p-18 xl:p-20 flex-col-reverse px-6*/}

          <div className="flex justify-around max-lg:flex-col">

            <div className="min-w-2/3 my-auto">
              <Image
                src={portrait}
              ...
              <p className="text-md md:text-lg lg:text-lg text-muted-foreground mt-4">
