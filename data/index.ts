...
export const gridItems = [
  {
    ...
    description: "",
    className: "lg:col-span-3 md:col-span-6 md:row-span-4",//"lg:col-span-2 lg:row-span-3 md:col-span-6 md:row-span-3", // change lg:col-span-3 md:row-span-4 lg:min-h-[60vh]
  ...
  },
  {
    ...
    description: "",
    className: "lg:col-span-2 md:col-span-3 md:row-span-2", //"lg:col-span-3 md:col-span-3 md:row-span-2 lg::row-span-3",
    imgClassName: "",
  ...
  },
  {
    ...
    className: "lg:col-span-2 md:col-span-3 md:row-span-2", //"lg:col-span-3 lg:raw-span-3 md:col-span-3 md:row-span-3",
    imgClassName: "",
  ...
  },
  {
    ...
    description: "",
    className: "lg:col-span-2 md:col-span-3 md:row-span-1",//"lg:col-span-2 lg:raw-span-3 md:col-span-3 md:row-span-2",
    imgClassName: "",
    titleClassName: "justify-start",
    img: "/grid.svg",
    //width: 200,
