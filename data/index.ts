...
export const gridItems = [
  {
    ...
    description: "React.js | Redux | Axios | Interceptor | Rest API | PropTypes",
      ...
      "Solution : Utilisation Redux pour centraliser la gestion de l'état, ce qui a permis de synchroniser les données entre les composants de manière efficace.",
      " ",
      ...
      "Solution : : Utilisation de PropTypes pour valider les types de données dans les composants et mis en place une validation pour garantir l'intégrité des données.",
      " ",
...

  {
    ...
    "Solution : J'ai utilisé Semantic UI et testé l'application sur différents appareils et résolutions pour m'assurer qu'elle s'adapte correctement à toutes les tailles d'écran.",
    "",
    ...
    "Solution : J'ai utilisé PropTypes pour valider les types de données dans les composants React et j'ai mis en place des validations supplémentaires côté serveur pour garantir l'intégrité des données.",
    ],
...

  {
    ...
    " Solution : J'ai mis en place une structure modulaire avec des classes abstraites et l'utilisation de namespaces pour une meilleure organisation du code.",
    " ",
